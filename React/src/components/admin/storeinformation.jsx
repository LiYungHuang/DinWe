...
export default function StoreInformation(props) {
  ...
  useEffect(() => {
    let result = async () => {
      try {
        ...
        setResturant(data.data.data[0]);

        let data2 = await axios.get(
          "http://127.0.0.1:8000/api/facilitiesStore/" + resId
        );
        // console.log(data2.data[0]);
        setFacilities(data2.data[0]);
        ...
        const opentime = await axios.get(
          "http://127.0.0.1:8000/api/getOpenTime/" + resId
        );
        // console.log(opentime.data.data);
        setOpentimes(opentime.data.data);
  ...
  return (
    <Fragment>
          ...
          <div className="container-fluid">
            ...
            <div className="d-flex">
              ...
              {token ? (
                ...
                <div className="btn btn-light border-dark rounded-pill lgiBtn">
                  <a
                    href="/login"
                    className="d-block mx-auto my-2 text-dark"
                    width="20"
                    height="20"
        ...
        <div className="container" style={{ marginTop: "5vh", width: "75vw" }}>
          ...
          <div className="row">
                  ...
                  <div className="d-flex flex-wrap">
                    <div className="col-3">
                      <div className="card-body">
                        ...
                        {facilities.pay.map((facility, index) => {
                          return (
                            <p
                              className="my-2 me-2"
                              style={{
                    ...
                    <div className="col-3">
                      <div className="card-body">
                        ...
                        {facilities.facility.map((facility, index) => {
                          return (
                            <p
                              className="my-2 me-2"
                              style={{
                    ...
                    <div className="col-3">
                      <div className="card-body">
                        ...
                        {facilities.child.map((facility, index) => {
                          return (
                            <p
                              className="my-2 me-2"
                              style={{
                    ...
                    <div className="col-3">
                      <div className="card-body">
                        ...
                        {facilities.food.map((facility, index) => {
                          return (
                            <p
                              className="my-2 me-2"
                              style={{
            ...
            <div className="col-md-4">
              <div className="card mb-4 shadow">
                <div className="card-body">
                  <h4 className="text-center text-secondary mb-3">營業時間</h4>
                  <hr />
                  <div className="rounded w-100 border border-top pt-3 pb-2">
                    {opentimes.map((item, index) => {
                      return (
                        <React.Fragment key={index}>
                          <div className="row justify-content-center mx-2 mb-2 ms-2">
                            ...
                            <div className="col text-start">
                              {item.isOpen === 1 ? (
                                ...
                                <span className="text-center">公休</span>
                              )}
                            </div>
                          </div>
                        </React.Fragment>
              ...
              <div className="card mb-4 shadow">
                <div className="card-body">
                  <h4 className="text-center text-secondary mb-3">營業地點</h4>
                  <hr />
                  <div className="rounded w-100 border border-top">
                    <iframe
                      src={resturant.resturant_ifram}
                      className="w-100"
                      height="250px"
                      style={{ border: 0 }}
                      allowFullScreen=""
              ...
              <div className="card mb-4 shadow">
                ...
                >
                  ...
                  >
                    <div className="carousel-inner lh-lg" id="comment">
              ...
              <div className="card shadow">
                <div className="card-body" style={{ height: "342px" }}>
      ...
      <footer className="text-center text-white majorColor mt-5">
        <div className="text-center p-3 bgc text-black majorColor">
          © 2023 Copyright:
          <a className="text-black" href="/index">
            DingWe.com
          </a>
        </div>
      </footer>
